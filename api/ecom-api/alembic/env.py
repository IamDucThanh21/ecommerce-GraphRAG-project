...
from ecom_schema import _schema, _pgentity
...
target_metadata = EcomConnector.__data_schema_base__.metadata
sync_url = ecom_config.DB_DSN.replace('+asyncpg://', '+psycopg2://')
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            compare_type=True,
            include_server_default=include_server_default,
            version_table='ecom_schema_alembic'
        )
